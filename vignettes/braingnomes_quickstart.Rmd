...
Diagnosis is not a routine prerequisite. Use `diagnose_project()` when current
failed, blocked, or cancelled work needs investigation:
...
Supply a run ID for a historical post-mortem. The guided dependency and log
browser is available through `interactive = TRUE`:
